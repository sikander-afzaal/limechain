...
function Talk() {
  return (
    <div className="flex justify-center items-center w-full lg:px-5 mt-[100px]  bg-white">
      <div className="flex isolate gap-1 justify-center lg:flex-row flex-col items-center  w-full  shadow-service 3xl:max-w-[2000px] max-w-[1244px] relative">
        <div className="p-5 lg:pl-5 lg:p-0 flex justify-center items-start flex-col w-full lg:w-1/2 gap-3">
          ...
          <Fade delay={1500}>
            <div className="flex justify-center xl:justify-start flex-col w-full xl:flex-row items-center gap-4">
              <a
                href="#about"
