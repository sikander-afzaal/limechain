...
const Hero = () => {
  return (
    <div className="flex isolate w-full pt-[100px] xl:pt-[200px] justify-start items-center relative flex-col">
      {/* shadows------------ */}
      ...
      <div className="flex justify-center items-center flex-col w-[90%] max-w-[1100px]">
        ...
        <div className="flex justify-center mt-8 items-center relative w-full">
          <img
            src={heroPerson}
            className="object-contain w-full max-w-[540px]"
            alt=""
          />
          <div className="flex justify-start items-start flex-col  max-w-[300px] absolute left-0 top-[22%] sm:top-[57%] -translate-y-1/2 gap-5 sm:gap-10">
