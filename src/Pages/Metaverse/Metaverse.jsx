  ...
  return (
    <div className="w-full overflow-x-hidden  relative isolate flex justify-start items-center flex-col bg-metaverse ">
      ...
      <div className=" w-full overflow-x-hidden flex justify-between items-start absolute left-0 top-0 -z-10">
        <h1 className=" font-chivo font-black text-[#FFFFFF0D] vertical-text whitespace-nowrap text-[90px] sm:text-[150px] lg:text-[200px] leading-[1] -translate-x-6">
          META LABZ AI
        </h1>
        <h1 className="font-chivo  font-black text-[#FFFFFF0D]  vertical-text2 whitespace-nowrap  text-[90px] sm:text-[150px] lg:text-[200px] leading-[1] rotate-180  translate-x-6 mt-[80px] sm:mt-[150px] origin-center">
          META LABZ AI
        </h1>
      </div>
      <Hero />
